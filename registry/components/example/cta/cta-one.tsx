  ...
  return (
    <section className="relative rounded-xl border py-20 overflow-hidden">
      <Particles
        ...
        refresh
      />
      <div className="absolute left-1/2 top-1/2 -z-50 h-32 w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-gradient-to-br from-orange-600 to-amber-600 opacity-50 blur-[200px]" />
