...
const Pricing = () => {
  ...
  return (
    <section className="py-20">
      <div className="px-4">
        <div className="sm:max-w-lg mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 sm:max-w-96 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {plans.map((plan) => (
            ...
            >
              {plan.name === "Growth" && (
                <div className="absolute -top-5 inset-x-0 mx-auto w-32 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 px-3 py-2 text-center text-sm font-medium text-white">
                  Popular
                </div>
              )}
              <div className="p-8">
              ...
              <div className="flex items-center justify-center border-y px-8 py-5">
                <a
                  ...
                  className={cn(
                    ...
                    plan.name === "Starter" &&
                      "bg-black dark:bg-gray-700 hover:bg-gray-800",
