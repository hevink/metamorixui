  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={isInView ? { opacity: 1 } : {}}
        transition={{ duration: 0.5 }}
        className="mx-auto mt-12 grid max-w-lg gap-5 gap-y-10 md:grid-cols-2 lg:max-w-none lg:grid-cols-3"
      >
        {blogPosts.map((post, index) => (
          ...
          >
            <div className="mb-6 shrink-0 overflow-hidden rounded-xl">
              <motion.img
