...
const example: Registry = {
  ...
  "hero-six": {
    name: "hero-six",
    type: "components:example",
    files: ["registry/components/example/hero/hero-six.tsx"],
    component: React.lazy(
      () => import("@/registry/components/example/hero/hero-six"),
    ),
  },
  "faq-one": {
    name: "faq-one",
  ...
  "mode-toggle": {
    name: "mode-toggle",
    type: "components:example",
    files: ["registry/components/mode-toggle.tsx"],
    component: React.lazy(() => import("@/registry/components/mode-toggle")),
  },
};
