...
const components = {
  ...
  Separator: ({ ...props }) => (
    <Separator
      className="mb-10 mt-24 [background:radial-gradient(50%_100%_at_50%_100%,rgba(0,0,0,.32)_0%,rgba(0,0,0,0)_100%)] dark:[background:radial-gradient(50%_100%_at_50%_100%,rgba(255,255,255,.32)_0%,rgba(255,255,255,0)_100%)]"
      {...props}
    />
  ),
  TabsList: ({
