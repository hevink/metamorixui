...
const Footer = () => {
  return (
    <footer>
      <div className="relative z-10 overflow-hidden py-4 backdrop-blur-lg sm:py-10 md:rounded-t-2xl">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:mt-16 xl:col-span-2 xl:mt-0">
