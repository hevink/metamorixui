...
const Hero = () => {
  return (
    <motion.section className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_0%,black_100%,transparent)] dark:[mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] bg-black">
      ...
      >
        <div className="absolute size-2  left-0 bg-white rounded-full top-1/2  -translate-x-1/2  -translate-y-1/2  inline-flex items-center justify-center " />
        <div className="absolute size-2  left-1/2 bg-white rounded-full top-0  -translate-x-1/2  -translate-y-1/2  inline-flex items-center justify-center " />
      ...
      >
        <div className="absolute size-2 left-0  bg-white rounded-full top-1/2 -translate-x-1/2  -translate-y-1/2  inline-flex  items-center justify-center " />
        <div className="absolute size-2 left-full  bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2  inline-flex  items-center justify-center " />
      </motion.div>
