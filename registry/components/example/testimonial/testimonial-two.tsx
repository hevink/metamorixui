          ...
          <div className="w-full max-w-6xl mx-auto">
            <div className="text-center max-w-xl mx-auto">
              ...
              <div className="text-center mb-10">
                ...
                <span className="inline-block w-3 h-1 rounded-full bg-[#FE6019] ml-1"></span>
                <span className="inline-block-1 h-1 rounded-full bg-[#FE6019] ml-1"></span>
              </div>
            </div>
            <div className="-mx-3 md:flex items-start">
              <div className="px-3 md:w-1/3">
                <div className="w-full mx-auto rounded-lg border dark:border-gray-800 p-5 text-gray-800 font-light mb-6">
